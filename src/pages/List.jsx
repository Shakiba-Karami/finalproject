    ...
    return (
        ...
        <div className="flex mb-8">
            ...
            <div className="grow text-center">
                ...
                <p className="text-xs font-light opacity-40">for : "{query}" </p>
            </div>
            <User/>
        </div>
        <Search/>
        ...
        <ul className="my-8">{data.map((movieItem) => (
                <li className="flex gap-5" key={movieItem.id} onClick={()=>navigate(`/item/${movieItem.id}`)}
                >
                    <img className="rounded-t-xl " src={movieItem.poster} alt={movieItem.title} width = {137} height={137}/>
                    <div>
