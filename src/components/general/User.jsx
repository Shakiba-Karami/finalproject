...
const User = () => {
    ...
    return (
            <button onClick = "()=> {}" className="group flex items-center p-2 bg-[var(--interactive-color)] size-10 rounded-xl fill-white hover:fill-[var(--accent-color)] cursor-pointer">
                    ...
                    <path d="M34,215.1c5.2-12.2,12.5-23.1,21.9-32.5c9.4-9.4,20.2-16.7,32.3-21.9c4.3-1.8,6.5-7,4.6-11.3c-1.9-4.3-6.8-6.2-11.1-4.4c-14.2,6-26.9,14.6-37.9,25.6c-10.9,11-19.5,23.7-25.5,37.9c-3.9,9.3-6.6,19-8.1,29c-0.7,5.2,3.3,9.7,8.5,9.7l0,0c4.2,0,7.8-3.1,8.4-7.3C28.3,231.3,30.6,223,34,215.1z"/></g></g>
                    </svg>
            </button>
    )
}
