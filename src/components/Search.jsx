...
const Search = ({url}) => {
    ...
    <form className='w-full' onSubmit = {handleSubmit(onSubmit)}>
        <div  className='bg-[var(--interactive-color)] px-4 py-3 my-8 rounded-2xl flex'>
            <button className='group cursor-pointer' type='submit' disabled={!nameQuery.trim()}>
            ...
            <button type='button'className='group border-l-2 border-[#070D23] pl-2.5 cursor-pointer'>
                <svg className="fill-white/80 group-hover:fill-[var(--accent-color)]" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
